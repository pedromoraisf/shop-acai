    ...
    <b-container class="p-4 p-sm-5 p-md-5 p-lg-5 p-xl-5">
      ...
      <div class="sub-container">
        ...
        <header class="text-center position-relative">
          ...
          <button @click.prevent="commitShowAddOrder(!showAddOrder)" class="bg-transparent border-0 outline-none h-100">
        ...
        <section>
          ...
          <div class="mt-3">
            <div class="p-3 bg-light rounded d-flex justify-content-between align-items-start">
              ...
              <span class="badge badge-light shadow-ghost d-flex align-items-center p-2" v-html="`Obrigatório`" />
            </div>
            <div class="pb-3">
              <vs-radio class="justify-content-start px-3 pt-3" :color="s.cor" v-model="acai.sabor" v-for="s in saborOpcoes" :key="s.id" :val="s.id">
                {{ s.descricao }}
                <template #icon>
        ...
        <footer class="mt-5" v-if="acai.sabor !== '' && acai.tamanho !== ''">
          <div class="d-flex justify-content-between align-items-center">
            <span class="font-weight-bold d-flex mb-0" v-html="$options.filters.precoFilter(valorTotal)" />
